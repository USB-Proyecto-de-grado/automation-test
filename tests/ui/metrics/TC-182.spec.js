...
describe('Annual Metrics Page Publicaciones Bar Verification [Tag: GUI Testing][Tag: API Testing]', function () {
  this.timeout(60000);
  let driver;
  ...
  before(async () => {
    ...
    await createMiscPublicationEntries(1); // Create a misc publication entry
  });
  ...
  it('TC-182: Verify the purple bars and pie chart for Publicaciones metrics are displayed [Tag: GUI Testing] [Tag: API Testing]', async function () {
    ...
    const expectedPurpleColor = 'rgb(184, 0, 216)'; // Purple color expected for "Publicaciones"
