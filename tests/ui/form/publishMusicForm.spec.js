...
describe('Publish Music Form Tests [Tag: GUI Testing][Tag: Functional Testing]', function() {
    ...
    it('TC-158: should show validation errors when fields the field Link is worng typed [Tag: GUI Testing] [Tag: Negative Testing] [Tag: Functional Testing]', async function() {
        await driver.sleep(5000)
        await publishMusicFormPage.fillMusicForm({
            youTubeLink: 'a',
            title: 'a',
    ...
    it('TC-159: should show validation errors when the youtubeLink is with an empty space [Tag: GUI Testing] [Tag: Negative Testing] [Tag: Functional Testing]', async function() {
        await driver.sleep(5000)
        await publishMusicFormPage.fillMusicForm({
            youTubeLink: ' ',
            title: 'a',
    ...
    it('TC-160: should show validation errors when the title is with an empty space [Tag: GUI Testing] [Tag: Negative Testing] [Tag: Functional Testing]', async function() {
        await driver.sleep(5000)
        await publishMusicFormPage.fillMusicForm({
            youTubeLink: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
            title: ' ',
    ...
    it('TC-161: should show validation errors when the description is with an empty space [Tag: GUI Testing] [Tag: Negative Testing] [Tag: Functional Testing]', async function() {
        await driver.sleep(5000)
        await publishMusicFormPage.fillMusicForm({
            youTubeLink: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
            title: 'Never Gonna Give You Up',
