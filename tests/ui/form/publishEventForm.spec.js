...
describe('Publish Event Form Tests [Tag: GUI Testing][Tag: Functional Testing]', function () {
  ...
  it('TC-151: submit successfully when the ubication dont exist in the database [Tag: GUI Testing] [Tag: Negative Testing] [Tag: Functional Testing]', async function () {
    await driver.sleep(5000)
    await publishEventFormPage.fillEventForm({
      title: 'Veladas de invierno - UMSS',
      date: '08/12/2024',
  ...
  it('TC-152: should show validation errors when the price is negative [Tag: GUI Testing] [Tag: Negative Testing] [Tag: Functional Testing]', async function () {
    await driver.sleep(5000)
    await publishEventFormPage.fillEventForm({
      title: 'Veladas de invierno - UMSS',
      date: '08/12/2024',
  ...
  it('TC-154: should show validation errors when the description is with an empty space [Tag: GUI Testing] [Tag: Negative Testing] [Tag: Functional Testing]', async function () {
    await driver.sleep(5000)
    await publishEventFormPage.fillEventForm({
      title: 'Veladas de invierno - UMSS',
      date: '08/12/2024',
  ...
  it('TC-155: should show validation errors when the description is with an empty space [Tag: GUI Testing] [Tag: Negative Testing] [Tag: Functional Testing]', async function () {
    await driver.sleep(5000)
    await publishEventFormPage.fillEventForm({
      title: 'Veladas de invierno - UMSS',
      date: '08/12/2024',
