...
describe('Publish Event Form Tests [Tag: GUI Testing][Tag: Functional Testing]', function () {
  ...
  it('TC-155: should show validation errors when the description is with an empty space [Tag: GUI Testing] [Tag: Negative Testing] [Tag: Functional Testing]', async function () {
    // Given the user is on the Publish Event form page and enters only a space as the description
    ...
    // Then the user should see validation errors about the empty description
