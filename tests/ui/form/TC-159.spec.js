...
describe('Publish Music Form Tests [Tag: GUI Testing][Tag: Functional Testing]', function() {
    ...
    it('TC-159: should show validation errors when the YouTube link field is empty [Tag: GUI Testing] [Tag: Negative Testing] [Tag: Functional Testing]', async function() {
        // Given the YouTube link field is empty
